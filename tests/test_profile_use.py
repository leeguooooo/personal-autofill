...
class ValueFormatTests(unittest.TestCase):
    ...
    def test_to_fullwidth_matches_the_bank_form(self):
        self.assertEqual(pa.to_fullwidth("25番57-402号"), "２５番５７－４０２号")
        self.assertEqual(pa.to_fullwidth("201-0001"), "２０１－０００１")
        # Kana/kanji/spaces untouched; nested containers handled; non-strings pass.
        self.assertEqual(pa.to_fullwidth({"r": ["Room 402", 7]}), {"r": ["Ｒｏｏｍ ４０２", 7]})
    ...
    def test_values_applies_formats_only_where_they_belong(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.run_cli(tmp, "set", "address.jp.postal_code_hyphenated", "201-0001")
            ...
            self.assertEqual(out["address.jp.postal_code_hyphenated"], "201-0001")
            ...
            self.assertEqual(out["address.jp.postal_code_hyphenated"], "２０１－０００１")
