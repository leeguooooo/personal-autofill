...
def to_fullwidth(value: Any) -> Any:
    ...
    remainder "as written on the ID" in full-width: 25番57-402号 becomes
    ２５番５７－４０２号. Everything else (kana, kanji, spaces, punctuation)
...
def build_parser() -> argparse.ArgumentParser:
    ...
    values.add_argument(
        ...
        help="jp-fullwidth: ASCII digits/letters/hyphens in returned strings as full-width (２５－５７－４０２), for Japanese forms.",
    )
